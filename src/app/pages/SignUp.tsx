...
export function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(normalizeApiError(submitError, 'Unable to sign up.'));
    } finally {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.14),transparent_28%),linear-gradient(135deg,#faf5ff_0%,#ffffff_45%,#eff6ff_100%)] p-4">
      <div className="absolute -left-20 bottom-10 h-72 w-72 rounded-full bg-blue-200/30 blur-3xl" />
      <div className="absolute -right-24 top-10 h-80 w-80 rounded-full bg-violet-300/25 blur-3xl" />
      <div className="relative z-10 w-full max-w-md">
        {/* Logo/Brand */}
        <div className="text-center mb-8">
          <BrandLogo size="lg" showTagline centered />
          <p className="mt-4 text-sm text-neutral-600">Join our community today</p>
        </div>
